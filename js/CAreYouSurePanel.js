function CAreYouSurePanel(szText, oFunction) {
    ...
    this._init = function (oFunction) {
        ...
        var iHeight = oSprite.height-210;
        var iX = 0;
        var iY = -80;
        ...
        _oButYes = new CGfxButton(110, 110, s_oSpriteLibrary.getSprite('but_yes_big'), _oPanelContainer);
        _oButYes.addEventListener(ON_MOUSE_UP, this._onButYes, this);

        _oButNo = new CGfxButton(-110, 110, s_oSpriteLibrary.getSprite('but_no'), _oPanelContainer);
