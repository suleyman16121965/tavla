function CAlertBox (oParentContainer) {
    ...
    this.init = function(oParentContainer){
        ...
        _oText = new CTLText(_oContainer, 
                    ...
                    38, "center", FONT_COLOR, PRIMARY_FONT, 1.1,
                    2, 2,
                    " ",
                    true, true, true,
                    false );
        ...
        _iYStartContainer = CANVAS_HEIGHT+oSprite.height;
    ...
    this.show = function(szText){
       ...
       new createjs.Tween.get(_oContainer).wait(600).to({y: CANVAS_HEIGHT/2+200},500,createjs.Ease.cubicOut).wait(1600).call(function(){
           if (!_bIsHide){
               _oParent.hide();
           }
       });
