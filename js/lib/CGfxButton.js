function CGfxButton(iXPos,iYPos,oSprite, oParentContainer){
    ...
    this.pulseAnimation = function () {
        createjs.Tween.get(_oButton, {loop:true}).to({scaleX: _iScaleFactor*0.9, scaleY: _iScaleFactor*0.9}, 850, createjs.Ease.quadOut)
                .to({scaleX: _iScaleFactor, scaleY: _iScaleFactor}, 650, createjs.Ease.quadIn);
    };

    this.trembleAnimation = function () {
        createjs.Tween.get(_oButton, {loop:true}).to({rotation: 5}, 75, createjs.Ease.quadOut).to({rotation: -5}, 140, createjs.Ease.quadIn)
